<nav id="sidebar" class='mx-lt-3 bg-dark' style="width: 200px;">
  <div class="sidebar-list" style="padding-top: 10px; max-height: calc(100vh - 50px); overflow-y: auto;">
    ...
    <?php if($_SESSION['login_type'] == 1): ?>
      <a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Usuarios</a><a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Usuarios</a>
    <?php endif; ?>
  </div>
</nav>
<script>
