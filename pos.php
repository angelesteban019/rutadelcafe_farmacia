					...
					<div class="col-md-12">
						...
						<div class="row mb-3">
								<div class="col-md-4">
									...
									<small><a href="javascript:void(0)" id="search_prod">Busca productos.</a></small>
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-3">
									...
									<button class="btn btn-block btn-sm" type="button" id="add_list"><i class="fa fa-plus"></i> Añadir a la Lista</button>
								</div>
									...
									?>
										<tr class="item-row">
											<td>
												...
												<p class="pname">Nombre: <b><?php echo $prod[$row['product_id']]['name'] ?></b></p>
												<p class="pdesc"><small><i>Descripción: <b><?php echo $prod[$row['product_id']]['description'] ?></b></i></small></p>
											</td>
											<td>
					    ...
					    <div class="modal-dialog modal-md" role="document">
					      ...
					      <div class="modal-body">
					      	<div class="container-fluid">
					      		...
					      		<div class="form-group">
					      			<label for="" class="control-label">Vendido Por:</label>
...
<script>
	...
	$('#pay').click(function(){
		if($("#list .item-row").length <= 0){
			alert_toast("Por favor, inserte al menos un articulo primero.",'danger');
			end_load();
			return false;
		}
	...
	$('#add_list').click(function(){
		...
		var product = $('#product').val(),
			...
			if(product == '' || qty == ''){
				alert_toast("Por favor, rellene los campos primero",'danger')
				return false;
			}
			$.ajax({
				...
				success:function(resp){
					...
					if(resp.available >= qty){
						...
						alert_toast("La cantidad del producto es mayor que el stock disponible.",'danger')
					}
				}
			})
	...
	$('#manage-sales').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp > 0){
					end_load()
					alert_toast("Datos enviados correctamente",'success')
