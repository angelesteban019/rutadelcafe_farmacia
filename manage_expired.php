			...
			<div class="card-body">
				<form action="" id="manage-expired">
					...
					<div class="col-md-12">
									...
									?>
										<tr class="item-row">
											...
											<td>
												...
												<p class="pname">Nombre: <b><?php echo $row['name'] ?> <sup><?php echo $row['measurement'] ?></sup></b></p>
												<p class="pdesc"><small><i>Descripción: <b><?php echo $row['description'] ?></b></i></small></p>
											</td>
											<td>
						...
						<div class="row">
							<div class="col-lg-12">
								<button class="btnSave  col-sm-3 btn-sm btn-block float-right ">Guarda</button>
							</div>
						</div>
					</div>
				</form>
