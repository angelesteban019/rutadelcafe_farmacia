	...
	<div class="col-lg-12">
		<div class="row">
			<div class="form-group col-md-4 ofsset-md-4">
				<small>Buscar por producto</small>
		...
		<table class="table table-condensed table-hover" id="plist">
			<colgroup>
				...
				<thead>
					...
					<th class="">Prescripción Necesaria</th>
				</thead>
				<tbody>
					<?php 
...
<div class="modal-footer display">
	<div class="col-lg-12">
		<button class="btn btn-secondary float-right" type="button" data-dismiss="modal">Cerrar</button>
	</div>
</div>
<script>
