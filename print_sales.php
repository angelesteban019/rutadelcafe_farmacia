	...
	<table width="100%">
				...
				<tr>
					<th class="text-center">
						<p><b>Drogueria La Ruta Del Café</b></p>
						<p>
							<b>Recibo Oficial</b>
						</p>
					</th>
				...
				<tr>
					<table width="100%">
						<tr>
							...
							<th width="30%" class="wborder text-left">Producto</th>
							<th width="10%" class="wborder"></th>
							<th width="25%" class="wborder">Lleva</th>
						</tr>
						<?php 
						...
						<tr>
							<th class="text-right wborder" colspan="3">Vendido con descuento</th>
							<th class="text-right wborder" ><?php echo number_format($amount_tendered,2) ?></th>
						</tr>
						<tr>
							<th class="text-right wborder" colspan="3">Cambio</th>
				...
				<tr>
					<td>
						<table width="100%">
							<tr>
								<td width="20%" class="text-right">Cliente :</td>
								<td width="40%" class="bbottom"><?php echo ucwords($cname) ?></td>
								<td width="20%" class="text-right">Fecha :</td>
